"""Constants shared between bot_processors.price_lookup (reads the cache,
drives the live conversation) and bot_processors.agmarknet_scraper (writes
...
# bot_processors.price_lookup (resolving a caller's spoken commodity to a
# lookup key) and bot_processors.agmarknet_scraper (writing that same key
