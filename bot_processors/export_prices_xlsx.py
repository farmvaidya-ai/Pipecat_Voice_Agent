...
reads/writes; last_known_prices.json (bot_processors/price_shared.py's
_LAST_KNOWN_PATH) remains the actual runtime store.

Usage: python -m bot_processors.export_prices_xlsx [output_path.xlsx] [--date=DD-MM-YYYY]
...
from bot_processors.price_shared import _LAST_KNOWN_KEY_SEP, _LAST_KNOWN_PATH
