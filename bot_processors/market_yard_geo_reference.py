...
CLI: python -m bot_processors.market_yard_geo_reference
"""
...
_SOURCE_PATH = Path(__file__).parent / "AP_Telangana_Market_Yards_filled.xlsx"
_CACHE_PATH = Path(__file__).parent / "market_yard_geo_cache.json"
...
if __name__ == "__main__":
    output_path = sys.argv[1] if len(sys.argv) > 1 else "bot_processors/market_yard_geo_reference.json"
