...
CLI: python -m bot_processors.pincode_geo_reference bot_processors/all_ap_postoffices.xlsx
"""
...
from bot_processors.price_lookup import _fuzzy_match

_CACHE_PATH = Path(__file__).parent / "pincode_geo_cache.json"
...
if __name__ == "__main__":
    xlsx_path = sys.argv[1] if len(sys.argv) > 1 else "bot_processors/all_ap_postoffices.xlsx"
    output_path = sys.argv[2] if len(sys.argv) > 2 else "bot_processors/pincode_geo_reference.json"
