...
from bot_processors.rag.intent_router import classify_intent
...
class RAGInjector(FrameProcessor):
    ...
    Turns that bot_processors.rag.intent_router.classify_intent recognizes as
    clearly weather or mandi-price questions skip the search entirely —
    get_weather/get_price (bot_processors/location/weather_lookup.py, pricing/price_lookup.py)
