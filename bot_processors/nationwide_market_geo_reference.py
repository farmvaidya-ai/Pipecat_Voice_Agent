...
CLI: python -m bot_processors.nationwide_market_geo_reference
"""
...
_CACHE_PATH = Path(__file__).parent / "nationwide_market_geo_cache.json"
...
if __name__ == "__main__":
    output_path = sys.argv[1] if len(sys.argv) > 1 else "bot_processors/nationwide_market_geo_reference.json"
